...
PickupTypes = F_MakeReadOnlyTable("PickupTypes", 
	{
		None = 0,				-- No pickup
...
Pickup = F_Class("Pickup")

-- @brief Initializes a pickup entity with given params.
-- @param params Table of parameters (type, soundfx, position, texture, dimensions, etc.)
