...
function Projectile:Update()
	...
	if transform.position.x < 0 or transform.position.x > F_WindowWidth() or 
		transform.position.y < 0 or transform.position.y > F_WindowHeight() then
		return false
	end
