...
namespace Feather {
	...
	*/
	...
	inline void RemoveSuffixIfPresent(std::basic_string<CharT, Traits, Alloc>& str, std::basic_string_view<CharT, Traits> suffix)
	{
	...
	template <typename CharT, typename Traits, typename Alloc>
	inline void RemovePrefixIfPresent(std::basic_string<CharT, Traits, Alloc>& str, std::basic_string_view<CharT, Traits> prefix)
	{
	...
	template <typename CharT, typename Traits, typename Alloc>
	[[nodiscard]] inline std::basic_string<CharT, Traits, Alloc> RemoveSuffixCopy(std::basic_string<CharT, Traits, Alloc> str, std::basic_string_view<CharT, Traits> suffix)
	{
	...
	[[nodiscard]] inline std::basic_string<CharT, Traits, Alloc> RemoveSuffixCopy(std::basic_string<CharT, Traits, Alloc> str, const CharT(&suffix)[N])
	{
	...
	template <typename CharT, typename Traits, typename Alloc>
	[[nodiscard]] inline std::basic_string<CharT, Traits, Alloc> RemovePrefixCopy(std::basic_string<CharT, Traits, Alloc> str, std::basic_string_view<CharT, Traits> prefix)
	{
	...
	template <typename CharT, typename Traits, typename Alloc, size_t N>
	[[nodiscard]] inline std::basic_string<CharT, Traits, Alloc> RemovePrefixCopy(std::basic_string<CharT, Traits, Alloc> str, const CharT(&prefix)[N])
	{
