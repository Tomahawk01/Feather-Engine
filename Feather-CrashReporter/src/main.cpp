...
int main(int argc, char* argv[])
{
	...
	SDL_Window* pWindow = SDL_CreateWindow("Crash Reporter", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 640, 480, SDL_WINDOW_OPENGL);
	...
	while (!bDone)
	{
		...
		if (ImGui::Begin("Crash Reporter", nullptr,
						 ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoTitleBar))
		{
			ImGui::TextWrapped("A crash occured. Please see the log below and report it if needed:");

			ImGui::BeginChild("ScrollRegion", ImVec2{ 0.0f, -40.0f }, true, ImGuiWindowFlags_HorizontalScrollbar);
