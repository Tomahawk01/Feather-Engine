AssetDefs =
{
    textures =
    {
        ...
        { name = "forest", path = "assets/textures/forest.png" , pixel_art = true },
        { name = "vegetation", path = "assets/textures/vegetation.png" , pixel_art = true },
    ...
    music =
    {
        { name = "ambience_song", path = "assets/sounds/ambience_song.mp3" }
    },
    sound_fx =
    {
        { name = "rain", path = "assets/sounds/rain_sfx.mp3" }
    }
}
