...
namespace Feather {
	...
	template<CommandType ...Cmds>
	inline void AbstractCommandManager<Cmds...>::RunRedo(VarCommands<Cmds...>& redoVariant)
	{
		std::visit([&](auto&& val) { RunRedo_Impl(val); }, redoVariant);
	}
	...
	template<CommandType ...Cmds>
	template<CommandType TCmd>
	inline void AbstractCommandManager<Cmds...>::RunRedo_Impl(TCmd& redoCmd)
	{
		redoCmd.redo();
	}
